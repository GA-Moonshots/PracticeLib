...
public class Mecanum extends SubsystemBase {
    ...
    protected void drive(double m1, double m2, double m3, double m4) {
        leftFront.set(Range.clip(m1, -HardwareNames.MOTOR_MAX_SPEED, HardwareNames.MOTOR_MAX_SPEED));
        rightFront.set(Range.clip(m2, -HardwareNames.MOTOR_MAX_SPEED, HardwareNames.MOTOR_MAX_SPEED));
        leftBack.set(Range.clip(m3, -HardwareNames.MOTOR_MAX_SPEED, HardwareNames.MOTOR_MAX_SPEED));
        rightBack.set(Range.clip(m4, -HardwareNames.MOTOR_MAX_SPEED, HardwareNames.MOTOR_MAX_SPEED));
    }
